...
EXCLUDE_DIRS = {
    ...
    ".godot_user",
    "archive",
    "training/artifacts/server_logs",
    "training/packages",
    "training/runs",
    "training/data/replays",
    "training/data/replays_decision",
}
...
KEEP_FILES_IN_EXCLUDED_DIRS = {
    "training/data/replays/.gitkeep",
    "training/data/incoming_models/README.md",
    "training/artifacts/checkpoints/hybrid/README.md",
}
...
def build_manifest(bundle_name: str, files: list[BundleFile], created_at: str) -> dict:
    payload = {
        ...
        "server_agent_entrypoint": "training/SERVER_AGENT_PROMPT_zh.md",
        "entrypoints": {
            "agent_prompt": "training/SERVER_AGENT_PROMPT_zh.md",
            ...
            "replay_audit": "python training/audit_hybrid_replays.py --replay-dir training/data/replays",
            "decision_dataset": "python training/prepare_hybrid_replays.py --input-dir training/data/replays --output-dir training/data/replays_decision",
            "web_preview": {
